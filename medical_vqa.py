...
def main():
    ...
    if active_tab == "🔬 Medical Analysis":
        ...
        <div class="analysis-section">
            ...
            <h4>🔍 Core Features</h4>
            <ul>
                <li>🩻 Medical Image Analysis for X-rays, CT scans, MRIs, and ultrasounds</li>
                <li>🌍 Bilingual support for English and Arabic</li>
                <li>🧠 AI-powered analysis specialized for medical imaging</li>
                <li>🎯 Context-aware understanding of medical terminology</li>
            </ul>
            ...
            <div style="background: #f0fdf4; padding: 1rem; border-radius: 0.75rem; border-left: 3px solid #14b8a6; margin-top: 1.5rem;">
                ...
                <p>Always consult with qualified healthcare professionals for medical decisions, diagnosis, and treatment. 
                AI-generated analysis should never replace professional medical judgment.</p>
            </div>
        </div>
        ''', unsafe_allow_html=True)
